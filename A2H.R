...
temp_file_ = tempfile()
# curl_download(url = 'https://github.com/4db83/TSEF-code/raw/main/data/real_gdp_US_2022Q4.parquet',
#               destfile = temp_file_)
curl_download(url = 'https://github.com/4db83/TSEF-code/raw/main/data/real_gdp_US_2022Q4.xlsx',
              destfile = temp_file_)
cat("\014")
# read US data
...
# BN Based on an AR(1)
mu_AR1      = arma10$coef[2]/(1 - arma10$coef[1]);
...
# lines(density(tstatC),  col='red'    , lwd=2)
# lines(density(tstatCT), col='orange' , lwd=2)
abline(h=0)
# Add a legend
legend(12700, 4.8, legend = c("HP-Filter Cycle", "BN-AR(1) Cycle", "BN-MA(1) Cycle"), 
